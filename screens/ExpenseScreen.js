    ...
    return (
      ...
      <CardItem>
        <Left>
          ...
          <Text note> Use the gear icon below to upload your receipts, and get insights about your expenditure and lifestyle from it </Text>
          </Body>
        </Left>
      </CardItem>
        <View style={{backgroundColor: 'white'}}><ExpenseTrack/></View>
